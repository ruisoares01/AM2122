...
public final class FragmentPerfilBinding implements ViewBinding {
  ...
  @NonNull
  public final LinearLayout linearMorada;
  ...
  private FragmentPerfilBinding(@NonNull RelativeLayout rootView, @NonNull Button buttonLogOut,
      @NonNull ImageView imgPickImage, @NonNull CircleImageView imgProfile,
      @NonNull LinearLayout linearMorada, @NonNull TextView profileCurso,
    ...
    this.linearMorada = linearMorada;
  ...
  public static FragmentPerfilBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.linearMorada;
      LinearLayout linearMorada = ViewBindings.findChildViewById(rootView, id);
      if (linearMorada == null) {
        break missingId;
      }
      ...
      return new FragmentPerfilBinding((RelativeLayout) rootView, buttonLogOut, imgPickImage,
          imgProfile, linearMorada, profileCurso, profileEmail, profileMorada, profilenAluno,
          txtProfileName);
    }
